<?php
    ...
    class Page implements PublisherInterface
    {
        ...
        /**
         * retrieve a page instance identified by either its id (numeric) or alias (string)
         *
         * @param string|int $id
         * @return Page
         * @throws \Throwable
        ...
        /**
         * create a page and set all attributes stored in $data
         *
         * @param array $data
         * @return Page
         * @throws \Exception
        ...
        /**
         * sort revisions and return revision with the latest creation date
         * @return null|Revision
         *
         * @throws \Throwable
        ...
        /**
         * sort revisions and return revision with the earliest creation date
         * @return null|Revision
         *
         * @throws \Throwable
         * @todo do sorting only once
        ...
        {
            return array_find($this->getRevisions(), static fn($revision) => $revision->getFirstCreated() && $revision->getFirstCreated()->format(DATE_W3C) === $dateTime->format(DATE_W3C));
        }
         ...
         * the modification timestamp of the generated file is set to the creation timestamp of the active revision
         *
         * @throws \Throwable
         */
