<?php
    ...
    class Revision
    {
         ...
         * @var array[vxWeb\Orm\Revision]
         */
        private static array $instancesByPage;
         ...
         * @var array
         */
        private array $monitoredAttributes = ['title', 'keywords', 'description', 'markup'];
        ...
        public static function getInstancesForPage(Page $page, ?Locale $locale = null): array
        {
            ...
            } // get revisions for a specified locale
         ...
         *
         * to make change persistent, if a revision is already saved,
         ...
         * reset the active flag
         *
         * if the revision is already saved, ensure that the change is persisted
         */
        ...
        public function save(): self
        {
            ...
            // save by inserting a new revision record
            ...
            // add to the page map, if present
        ...
        /**
         * delete a revision,
         * remove record in the database (when already saved)
         * and entries in both id and page map
         */
        ...
        /**
         * get the primary key of revision
         * @return null|integer
         */
        ...
        /**
         * get the "parent" page of revision
         * @return Page
         */
         ...
         * DB wrapper sets this timestamp upon saving, if not set explicitly
         * @return null|\DateTime
         */
        ...
        /**
         * set the timestamp of record creation
         * required to synchronise timestamps with imported template files
         *
        ...
        /**
         * returns true when one of the monitored attributes
