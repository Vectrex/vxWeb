<?php
    ...
    class ArticleQuery extends Query
    {
         ...
         * @return self
         */
        public function filterByCategory(ArticleCategory $category): self
        {
         ...
         * @return $this
         */
        public function filterByCustomFlags(int $mask): self
        {
        ...
        /**
         * add WHERE clause that removes all unpublished articles from the resultset
         *
         * @return self
         */
        ...
        /**
         * add WHERE clause that removes all published articles from the resultset
         *
         * @return self
         */
        public function filterUnPublished(): self
        {
        ...
        /**
         * add a WHERE clause that filters for article category aliases
         *
         * @param array $categoryNames
         *
         * @return self
         */
        public function filterByCategoryNames(array $categoryNames): self
        {
        ...
        /**
         * add a WHERE clause that returns articles where $date is between Article::displayFrom and Article::displayUntil
         ...
         * @return self
         */
        public function filterByDisplayFromToUntil(?\DateTime $date = null): self
        {
            if (!$date) {
                $date = new \DateTime();
            }
        ...
        /**
         * executes a query and returns an array of Article instances
         *
         * @return Article[]
         * @throws \Throwable
         * @see Query::select()
