<?php
    ...
    class Article implements PublisherInterface
    {
         ...
         * array item contain both the metafile reference and additional
        ...
        /**
         * stores previously saved attribute values of an article
        ...
        /**
         * store a new article in the database or update changes to an existing article
         *
         * @throws \Throwable
        ...
        public function save(): void
        {
            ...
            // allow listeners to react to an event

            ArticleEvent::create(ArticleEvent::BEFORE_ARTICLE_SAVE, $this)->trigger();

            // afterward collect all current data in an array
            ...
            if ($this->updateLinkedFiles) {
                ...
                // save new references and use position in an array as the customSort value
        ...
        /**
         * link a metafile to the article; additionally links the article to metaFile
        ...
        public function linkMetaFile(MetaFile $file, ?int $sortPosition = null): self
        {
            ...
            if (!in_array($file, array_column($this->linkedFiles, 'file'), true)) {
                ...
                // append a file when no sort position is set or sort position beyond the linked files length
         ...
         * ensures proper re-ordering of a files array
         *
         * @param MetaFile $file
         * @return Article
         * @throws \Throwable
        ...
        /**
         * set the custom sort value of a file
         *
         * @param MetaFile $file
         ...
         * @throws \Throwable
         */
        public function setCustomSortOfMetaFile(MetaFile $file, int $sortPosition): self
        {
            // get all linked files if not done previously
            ...
            // is $sortPosition valid and different from the current position
            if (
        ...
        /**
         * get numeric id (primary key in db) of the article
         *
         * @return int|null
         */
        ...
        /**
         * get user id which created an article
         *
         * @return integer|null
         */
        ...
        /**
         * get a timestamp of article creation
         *
        ...
        /**
         * get custom flags of an article
         *
         * @return int|null
         */
        ...
        /**
         * set custom flags of an article
         *
        ...
        /**
         * sets misc data of an article; only keys listet in Article::dataCols are accepted
         *
         * @param array $data
         * @return self
         */
        ...
        /**
         * returns an array of MetaFile instances linked to the article
         *
         ...
         * returns true when a file is visible, false when a file is hidden
         *
         * @param MetaFile $file
         * @return bool
         * @throws \Throwable
        ...
        /**
         * returns an array of MetaFile instances with web image mimetype linked to the article
         *
         * @param bool $includeHidden
         * @return MetaFile[]
         * @throws \Throwable
        ...
        /**
         * set the 'published' attribute and store user id
         *
         ...
         * @return self
         */
        public function unpublish(?int $userId = null): self
        {
            $this->publishedById = (int)$userId ?: null;
         ...
         * @throws \Throwable
         */
        private static function createInstance(array $articleData): self
        {
            $article = new self();
            ...
            // backup values to check whether the record was changed
        ...
        /**
         * returns an article instance identified by numeric id or alias
         *
         * @param int|string $id
         * @return self
         * @throws \Throwable
         */
        public static function getInstance(int|string $id): self
        {
            $db = Application::getInstance()->getVxPDO();
        ...
        /**
         * returns an array of Article objects identified by numeric id or alias
        ...
        public static function getArticlesForCategory(ArticleCategory $category): array
        {
            ...
            $rows = Application::getInstance()->getVxPDO()->doPreparedQuery('SELECT * FROM articles WHERE articlecategoriesID = ?', [$category->getId()]);

            foreach ($rows as $r) {
                if (!isset(self::$instancesById[$r['articlesid']])) {

                    // create an Article instance if it does not yet exist
