...
<div id="app">
    ...
    >
        ...
        <template v-slot:action="slotProps">
            <a class="btn btn-link webfont-icon-only tooltip" data-tooltip="Bearbeiten" :href="'<?= \vxPHP\Application\Application::getInstance()->getRouter()->getRoute('article_edit')->getUrl() ?>?id=' + slotProps.row.key">&#xe002;</a>
