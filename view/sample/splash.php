...
<main style="height: 100vh;" class="bg-gray">
    <div class="empty">
        ...
        <p class="empty-subtitle">
            These sample pages reside in the <code>sample</code> folders in <code>/view/</code> and <code>/src/Controller/</code> and are configured by <code>ini/sample.ini.xml</code>.<br>
